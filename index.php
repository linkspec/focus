  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Edit blockers</h5>
      ...
      <div class="modal-footer">
        <div class="modal-body" id="blockerEditModalSecondBody">
                  ...
                  <button type="button" class="btn btn-primary" id="addNewRequirement">Add</button>
...
<div class="modal fade" id="taskEditModal" tabindex="-1" role="dialog" aria-labelledby="taskEditModal" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="taskEditModalTitle">Task title</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body" id="taskEditModalBody">
        <div class="form-group">
          <label for="taskEditModalDescription">Description</label>
          <textarea class="form-control" id="taskEditModalDescription" rows="3"></textarea>
        </div>

        <div class="form-group">
          <label for="taskEditModalNotes">Notes</label>
        ...
        <div class="form-group">
          <label for="taskEditModalTimeRequired">Time required (Minutes)</label>
          <input class="form-control" id="taskEditModalTimeRequired" rows="1" type="text">
        </div>

      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        <button type="button" class="btn btn-primary" id="editTaskModalSave">Save changes</button>
      </div>
